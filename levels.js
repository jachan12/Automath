...
const levels = {
  ...
  9: { min: 1, max: 10, numVars: 3, expr: "(A+B)*C", story: "Lars plukker {0} æbler, og putter dem ned i bakken, hvor der i forvejen er {1} æbler. Nu skal han gøre det {2} gange mere. Hvor mange æbler ender han med at plukke?" },
  10: { min: 1, max: 15, numVars: 4, expr: "A+B-C*D", story: "Mette køber {0} blomster om mandagen og {1} blomster om tirsdagen. Hun sælger {2} blomster til {3} forskellige kunder. Hvor mange blomster har hun tilbage?" },
